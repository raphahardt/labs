...
class DoctrineOrmServiceProvider implements ServiceProviderInterface
{
    ...
    public function register(Container $app)
    {
        ...
        $app['orm.ems.config'] = function ($app) {
            $app['orm.ems.options.initializer']();
        ...
        $app['orm.strategy.naming'] = function () {
            return new DefaultNamingStrategy;
        };

        $app['orm.strategy.quote'] = function() {
            return new DefaultQuoteStrategy;
        };

        $app['orm.entity_listener_resolver'] = function() {
            return new DefaultEntityListenerResolver;
        };

        $app['orm.repository_factory'] = function() {
        ...
        $app['orm.em.config'] = function () use ($app) {
